    ...
    return (
        <div>
            ...
            <div className="lg:flex justify-evenly items-center">
                <div className=''>
                <input type="email" placeholder="Email" className="input input-error my-2 " /> <br />
                <input type="password" placeholder="Password" className="input input-error my-2" /> <br />
                <button className='btn btn-info text-black'>Login</button> <br />
